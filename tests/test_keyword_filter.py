...
def test_filter_no_match(caplog: pytest.LogCaptureFixture) -> None:
...
def test_filter_with_match(caplog: pytest.LogCaptureFixture) -> None:
...
def test_filter_with_correct_tag(caplog: pytest.LogCaptureFixture) -> None:
